...
def generate_permutation(seed):
    ...
    Fixed seed (<=0xFFFFFFFF): deterministic via random.Random.
    Large seed (>0xFFFFFFFF): full entropy via secrets.SystemRandom.
    secrets.SystemRandom().shuffle() is Python 3.11+ safe.
    """
